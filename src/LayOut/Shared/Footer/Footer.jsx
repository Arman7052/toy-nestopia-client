...
const Footer = () => {
    return (
        ...
        <footer className=' bg-base-200 text-base-content '>
            <div className="flex flex-col py-2 text-center  lg:flex-row lg:justify-evenly p-5 px-5 ">
            ...
            <p className=' text-center font-serif py-5'>Copyright © 2023 - All right reserved</p>
        </footer>
